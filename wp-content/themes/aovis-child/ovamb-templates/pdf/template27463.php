	  		...
	  		<table style="width: 100%; border-collapse: collapse;" >
				...
				<tr class="ticket2">
					<td>
						...
						<div style="color: <?php echo $ticket['color_content_ticket']; ?>">
							<!-- Ticket Number -->
							<?php if(substr($ticket['seat'],0,2)=='GA') {echo 'General';} elseif(substr($ticket['seat'],0,2)=='VP') {echo 'VIP';} elseif(substr($ticket['seat'],0,2)=='SP') {echo 'Sponsor';} elseif(substr($ticket['seat'],0,2)=='SL') {echo 'Silver';} elseif(substr($ticket['seat'],0,2)=='GD') {echo 'Gold';}?>
						</div>
					</td>
					<td>
						<div style="color: <?php echo $ticket['color_label_ticket']; ?>">
						...
						<div style="color: <?php echo $ticket['color_content_ticket']; ?>">
							<!-- Ticket Number -->
							<?php if(substr($ticket['seat'],0,2)=='GA'||substr($ticket['seat'],0,2)=='SL') {echo substr($ticket['seat'],3);} else {echo substr($ticket['seat'],3,(strrpos($ticket['seat'], '-')+1)-strpos($ticket['seat'], '-')-2);} ?>
						</div>
					</td>
					<td>
					<div style="color: <?php echo $ticket['color_label_ticket']; ?>">
					...
					<div style="color: <?php echo $ticket['color_label_ticket']; ?>">
						...
						<div style="color: <?php echo $ticket['color_content_ticket']; ?>">
							<!-- Ticket Number -->
							<?php if(substr($ticket['seat'],0,2)=='GA'||substr($ticket['seat'],0,2)=='SL') {echo 'Free Seating';} else {echo substr($ticket['seat'],strrpos($ticket['seat'], '-')+2);}  ?>
						</div>
					</td>
				</tr>				
			</table>
...
<!--<img src="http://ticketing.phinnacleit.com/wp-content/uploads/2023/02/Moira.png" />-->
	<p style="text-align:center;">
		<img src="http://ticketing.phinnacleit.com/wp-content/uploads/2025/07/POOHKIE-Guam2-2-e1751881278247.jpg" class="center"/>
	</p>
<!-- Description Ticket -->
