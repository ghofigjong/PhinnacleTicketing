	  		...
	  		<table style="width: 100%; border-collapse: collapse;" >
				...
				<tr class="ticket2">
					<td>
						...
						<div style="color: <?php echo $ticket['color_content_ticket']; ?>">
							<!-- Ticket Number -->
							<?php if(substr($ticket['seat'],0,2)=='GA') {echo 'General';} elseif(substr($ticket['seat'],0,2)=='VP') {echo 'VIP';} elseif(substr($ticket['seat'],0,2)=='SP') {echo 'Sponsor';}  ?>
						</div>
					</td>
					<td>
						<div style="color: <?php echo $ticket['color_label_ticket']; ?>">
						...
						<div style="color: <?php echo $ticket['color_content_ticket']; ?>">
							<!-- Ticket Number -->
							<?php if(substr($ticket['seat'],3,1)=='L') {echo 'LEFT';} elseif(substr($ticket['seat'],3,1)=='R') {echo 'RIGHT';} elseif(substr($ticket['seat'],3,1)=='C') {echo 'CENTER';}  ?>
						</div>
					</td>
					<td>
					<div style="color: <?php echo $ticket['color_label_ticket']; ?>">
						...
						<div style="color: <?php echo $ticket['color_content_ticket']; ?>">
							<!-- Ticket Number -->
							<?php echo substr($ticket['seat'],5,1)  ?>
						</div>
					</td>
					<td>
					<div style="color: <?php echo $ticket['color_label_ticket']; ?>">
...
<!--<img src="http://ticketing.phinnacleit.com/wp-content/uploads/2023/02/Moira.png" />-->
	<img src="http://ticketing.phinnacleit.com/wp-content/uploads/2024/05/Moira_resize.jpg" />
<!-- Description Ticket -->
